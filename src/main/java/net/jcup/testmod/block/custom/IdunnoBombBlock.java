...
public class IdunnoBombBlock extends TntBlock {

    public IdunnoBombBlock(Settings settings) {
        super(settings);
    }
    ...
    private static void primeTnt(World world, BlockPos pos, LivingEntity igniter) {
        if (!world.isClient) {
            spawnBomb(world, pos.getX() + 0.5, pos.getY() + .1, pos.getZ() + 0.5, igniter);
    ...
    public void onDestroyedByExplosion(World world, BlockPos pos, Explosion explosion) {
        ...
        IdunnoBombEntity idunnoBomb = spawnBomb(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, explosion.getCausingEntity());
        int i = idunnoBomb.getFuse();
        idunnoBomb.setFuse((short)(world.random.nextInt(i / 4) + i / 8));
    ...
    private static IdunnoBombEntity spawnBomb(World world, double x, double y, double z, LivingEntity igniter) {
        IdunnoBombEntity idunnoBomb = IdunnoBombEntity.create(world, x, y, z, igniter);
